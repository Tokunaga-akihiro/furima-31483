...
describe User do
  ...
  describe 'ユーザー新規登録' do
    ...
    context '新規登録がうまくいかないとき' do
      ...
      it "ユーザー名字のフリガナは、名字と名前でそれぞれ必須であること" do
      @user.last_name_kana = 'hoge'
      @user.valid?
      expect(@user.errors.full_messages).to include("Last name kana is invalid. Input full-width katakana characters.")
      end
      it "ユーザー名前のフリガナは、名字と名前でそれぞれ必須であること" do
      ...
      @user.valid?
      expect(@user.errors.full_messages).to include("First name kana can't be blank", "First name kana is invalid. Input full-width characters.")
      end
